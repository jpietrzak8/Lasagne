...
#include "ui_lasdocumentationform.h"

LasDocumentationForm::LasDocumentationForm(QWidget *parent) :
  QWidget(parent),
  ui(new Ui::LasDocumentationForm)
{
  ui->setupUi(this);
...
LasDocumentationForm::~LasDocumentationForm()
{
  delete ui;
}
